...
const COPY = {
  zh: {
    ...
    proxy: { title: '代理与质量', proxy: '代理状态', quality: 'IP 质量', unknown: '待检测' },
  ...
  en: {
    ...
    proxy: { title: 'Proxy & quality', proxy: 'Proxy status', quality: 'IP quality', unknown: 'Pending' },
  ...
  fr: {
    ...
    proxy: { title: 'Proxy et qualité', proxy: 'État du proxy', quality: 'Qualité IP', unknown: 'En attente' },
  ...
  tr: {
    ...
    proxy: { title: 'Proxy ve kalite', proxy: 'Proxy durumu', quality: 'IP kalitesi', unknown: 'Bekleniyor' },
